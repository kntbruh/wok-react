    ...
    <div className={style.adv}>
      ...
      <div className={style.adv_grid}>
        ...
        <div className={style.adv_grid_item}>
          ...
          <p>
            Мы доставим ваш заказ быстро и надежно, чтобы вы могли насладиться
            вкусной лапшей вок.
          </p>
        </div>
        <div className={style.adv_grid_item}>
          ...
          <p>
            Мы ценим ваше время и предлагаем удобный сервис заказа и доставки.
          </p>
        </div>
        <div className={style.adv_grid_item}>
        ...
        <div className={style.adv_grid_item}>
          ...
          <p>
            Мы всегда готовы выслушать ваши пожелания и предложения, чтобы
            сделать ваше обслуживание максимально комфортным.
          </p>
        </div>
      </div>
    </div>
