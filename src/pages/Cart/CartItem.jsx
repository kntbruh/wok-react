    ...
    return (
        <div className={style.cart__item}>
            ...
            <div className={style.cart__item}>
                ...
                <b>{count}</b>
                <div onClick={minusProduct} className={style.button}>
            ...
            <div className={style.cart__item_remove}>
                <div className={style.button} onClick={removeProduct}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM184 232H328c13.3 0 24 10.7 24 24s-10.7 24-24 24H184c-13.3 0-24-10.7-24-24s10.7-24 24-24z" /></svg>
